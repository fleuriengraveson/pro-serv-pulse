...
export function getChartColors() {
	if (isDark()) {
		return {
			...
			categories: {
				meeting_internal: "#63B3ED",
				meeting_merchant: "#4FD1C5",
				data_migration: "#B794F4",
				admin: "#F6AD55",
				analytics: "#F472B6",
				research_sync: "#9AE6B4",
				internal_tools: "#48DBB4",
				api_scoping: "#FBB27D",
				hardware: "#FC8181",
				zendesk_admin: "#FAF089",
				lunch: "#4A4558",
				other: "#6B6580",
			},
			/* Tier colors */
		...
		return {
			...
			categories: {
				meeting_internal: "#3B82F6",
				meeting_merchant: "#0EA5E9",
				data_migration: "#8B5CF6",
				admin: "#F59E0B",
				analytics: "#EC4899",
				research_sync: "#84CC16",
				internal_tools: "#10B981",
				api_scoping: "#F97316",
				hardware: "#EF4444",
				zendesk_admin: "#EAB308",
				lunch: "#D6D3D1",
				other: "#94A3B8",
			},
			/* Tier colors */
