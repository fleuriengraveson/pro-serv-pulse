	...
	if (isDark()) {
		return {
			...
			categories: {
				...
				hardware: "#ae63d9",
				internal_tools: "#636ed9",
				meeting_internal: "#639bd9",
				meeting_merchant: "#5c9ae0",
				onboarding: "#63d9d1",
		...
		return {
			...
			categories: {
				admin_internal: "#f1eec5",
				admin_merchant: "#eae290",
				analytics: "#f2d1b0",
				api_scoping: "#f1c5cd",
				data_migration: "#f1c5e6",
				hardware: "#e1c5f1",
				internal_tools: "#c5c9f1",
				meeting_internal: "#c5daf1",
				meeting_merchant: "#90baea",
				onboarding: "#c5f1ee",
				research_sync: "#c5f1d4",
				troubleshooting: "#d0f1c5",
				lunch: "#C8C4C0",
				ooo: "#B0B8C0",
				other: "#A8A8A8",
			},
